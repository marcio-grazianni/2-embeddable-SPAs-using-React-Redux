...
## Embeddable Messaging & Scheduling Application

There are 3 distinct aspects to this deliverable:
1. A messaging application
2. A scheduling application
3. An embeddable JavaScript widget
