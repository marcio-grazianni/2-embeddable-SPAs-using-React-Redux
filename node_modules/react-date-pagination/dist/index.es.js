...
var css = ".react-date-pagination {\n  height: 36px;\n  margin: 18px 0;\n}\n.react-date-pagination ul {\n  padding: 0;\n  display: inline-block;\n  *display: inline;\n  /* IE7 inline-block hack */\n  *zoom: 1;\n  margin-left: 0;\n  margin-bottom: 0;\n  -ms-border-radius: 3px;\n  -webkit-border-radius: 3px;\n  -moz-border-radius: 3px;\n  border-radius: 3px;\n  -webkit-box-shadow: 0 1px 2px rgba(0, 0, 0, 0.05);\n  -moz-box-shadow: 0 1px 2px rgba(0, 0, 0, 0.05);\n  box-shadow: 0 1px 2px rgba(0, 0, 0, 0.05);\n}\n.react-date-pagination li {\n  display: inline;\n}\n.react-date-pagination li:first-child a {\n  border-left-width: 1px;\n  -webkit-border-radius: 3px 0 0 3px;\n  -moz-border-radius: 3px 0 0 3px;\n  border-radius: 3px 0 0 3px;\n  padding-left: 20px;\n  padding-right: 20px;\n}\n.react-date-pagination li:last-child a {\n  -webkit-border-radius: 0 3px 3px 0;\n  -moz-border-radius: 0 3px 3px 0;\n  border-radius: 0 3px 3px 0;\n  padding-left: 15px;\n  padding-right: 15px;\n}\n\n.react-date-pagination a {\n  float: left;\n  padding: 0 15px;\n  line-height: 34px;\n  text-decoration: none;\n  border-left-width: 0;\n  color: #444444;\n}\n.react-date-pagination a:hover {\n  background-color: #f5f5f5;\n}\n.react-date-pagination .active a {\n  color: #999999;\n  cursor: default;\n  background-color: #f5f5f5;\n}\n\n.react-date-pagination .disabled span,\n.react-date-pagination .disabled a,\n.react-date-pagination .disabled a:hover {\n  color: #999999;\n  background-color: transparent;\n  cursor: default;\n}\n\n.react-date-pagination a span{\n  padding: 2px;\n}\n";
styleInject(css);
...
var Page = function (_Component) {
  ...
  function Page() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Page.__proto__ || Object.getPrototypeOf(Page)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (e) {
      ...
      _this.props.onClick(pageNumber);
  ...
  createClass(Page, [{
    ...
    value: function render() {
      ...
      var elem = this.props.isNavigationPage === true ? React.createElement(
        'li',
        { className: isDisabled ? 'disabled' : '', onClick: function onClick(e) {
        ...
        'li',
        { className: isActive ? 'active' : '', onClick: function onClick(e) {
            return _this2.handleClick(e);
          } },
...
var Pagination = function (_React$Component) {
  ...
  function Pagination() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Pagination.__proto__ || Object.getPrototypeOf(Pagination)).call.apply(_ref, [this].concat(args))), _this), _this.paginationInfo = null, _temp), possibleConstructorReturn(_this, _ret);
  }
  ...
  createClass(Pagination, [{
    ...
    value: function isFirstPageVisible(hasPreviousPage) {
      var _props = this.props,
    ...
    value: function isPrevPageVisible(hasPreviousPage) {
    ...
    value: function isNextPageVisible(hasNextPage) {
    ...
    value: function isLastPageVisible(hasNextPage) {
    ...
    value: function buildPages() {
      ...
      this.paginationInfo = new paginator(itemsCountPerPage, pageRangeDisplayed).build(totalItemsCount, activePage);

      if (this.paginationInfo.next_page === this.paginationInfo.total_pages) {
        this.paginationInfo.has_next_page = false;
      }

      for (var i = this.paginationInfo.first_page; i <= this.paginationInfo.last_page; i++) {
        var date = days[i - 1];
      ...
      this.isPrevPageVisible(this.paginationInfo.has_previous_page) && pages.unshift(React.createElement(Page, {
        ...
        itemClass: classnames(itemClass, itemClassPrev),
        linkClass: classnames(linkClass, linkClassPrev),
        isNavigationPage: true
      }));

      this.isNextPageVisible(this.paginationInfo.has_next_page) && pages.push(React.createElement(Page, {
        ...
        itemClass: classnames(itemClass, itemClassNext),
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        { className: 'react-date-pagination' },
        React.createElement(
          'ul',
          null,
          pages
